...
(10, 'Carpaccio de boeuf', 'entree', 'Parmesan, roquette, huile de truffe', 'boeuf.jpg', 'classique', 'lactose'),
(11, 'Veloute potimarron', 'entree', 'Graines toastees, huile de noisette', 'veloute.jpg', 'vegan', ''),
(12, 'Salade quinoa', 'entree', 'Avocat, tomates confites, vinaigrette citron', 'salade.jpg', 'sans gluten', ''),
(13, 'Brochettes poulet halal', 'entree', 'Marinade orientale, menthe fraiche', 'poulet.jpg', 'halal', ''),
(14, 'Tartare de saumon', 'entree', 'Aneth, citron vert, avocat', 'saumon.jpg', 'pescetarien', 'poisson'),
(15, 'Terrine de canard', 'entree', 'Confiture de figues, pain brioche', 'canard.jpg', 'classique', 'gluten,lactose'),
(16, 'Gaszpacho andalou', 'entree', 'Concombre, poivron, croutons (sans)', 'salade.jpg', 'vegan', ''),
(17, 'Veloute de champignons', 'entree', 'Creme legere, persil', 'veloute.jpg', 'vegetarien', 'lactose'),
(18, 'Filet de boeuf', 'plat', 'Sauce morilles, pommes sarladaises', 'boeuf.jpg', 'classique', ''),
...
(24, 'Bar rôti', 'plat', 'Puree de patate douce, beurre citron', 'saumon.jpg', 'pescetarien', 'poisson'),
(25, 'Poulet basquaise', 'plat', 'Poivrons, tomates, riz parfume', 'poulet.jpg', 'sans lactose', ''),
(26, 'Lasagnes sans gluten', 'plat', 'Bolognaise maison, bechamel', 'image.jpg', 'sans gluten', 'lactose'),
...
(29, 'Mousse chocolat vegan', 'dessert', 'Cacao grand cru, fruits rouges', 'fondant.jpg', 'vegan', ''),
...
(32, 'Tarte citron', 'dessert', 'Meringue italienne', 'fruits.jpg', 'vegetarien', 'gluten,lactoeufs'),
(33, 'Financier amande', 'dessert', 'Sans farine de ble', 'tiramisu.jpg', 'sans gluten', 'oeufs,fruits a coque'),
(34, 'Mini burgers enfants', 'plat', 'Steak hache, frites maison', 'poulet.jpg', 'classique', 'gluten'),
(35, 'Nuggets poulet', 'plat', 'Sauce ketchup, legumes', 'volaille.jpg', 'classique', 'gluten'),
(36, 'Pates tomate', 'plat', 'Fromage rape, sans viande', 'risotto.jpg', 'vegetarien', 'gluten,lactose'),
(37, 'Brochettes boeuf BBQ', 'plat', 'Marinade fumee, salade verte', 'boeuf.jpg', 'classique', ''),
(38, 'Saucisses merguez', 'plat', 'Semoule, ratatouille', 'poulet.jpg', 'classique', ''),
(39, 'Poulet piri-piri', 'plat', 'Recette portugaise authentique', 'poulet.jpg', 'classique', ''),
(40, 'Bacalhau gratin', 'plat', 'Morue, pommes de terre, creme', 'saumon.jpg', 'pescetarien', 'poisson,lactose'),
(41, 'Mezze mediterraneens', 'entree', 'Houmous, taboule, falafels', 'salade.jpg', 'vegan', 'sesame'),
(42, 'Brunch sucre-sale', 'entree', 'Viennoiseries, oeufs brouilles', 'presentation.jpg', 'classique', 'gluten,lactoeufs'),
(43, 'Pancakes', 'dessert', 'Sirop d erable, fruits frais', 'fruits.jpg', 'vegetarien', 'gluten,lactoeufs'),
(44, 'Mini clafoutis', 'dessert', 'Cerises, sucre glace', 'fruits.jpg', 'vegetarien', 'gluten,lactoeufs');
