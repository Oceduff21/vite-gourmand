...
INSERT IGNORE INTO users (nom, prenom, email, gsm, telephone, password, role, is_active)
VALUES ('Test', 'Admin', 'testadmin@test.com', '0611223344', '0611223344',
'$2y$10$JfmsCrP1S2liy3hWG8Nwa.q1jmejbv3AP5cr4hrlyS3UmxHaoTUau', 'admin', 1);

INSERT IGNORE INTO users (nom, prenom, email, gsm, telephone, password, role, is_active)
VALUES ('Admin', 'Vite', 'admin@vite-gourmand.fr', '0611223344', '0611223344',
'$2y$10$JfmsCrP1S2liy3hWG8Nwa.q1jmejbv3AP5cr4hrlyS3UmxHaoTUau', 'admin', 1);
